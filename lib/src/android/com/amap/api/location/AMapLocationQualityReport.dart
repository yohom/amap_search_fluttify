...
class com_amap_api_location_AMapLocationQualityReport extends Ref_Android  {
  ...
  // 生成方法们
   Future<void> setWifiAble(bool var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.location.AMapLocationQualityReport::setWifiAble', {"var1": var1, "refId": refId});
   ...
   Future<void> setGpsStatus(int var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.location.AMapLocationQualityReport::setGpsStatus', {"var1": var1, "refId": refId});
   ...
   Future<void> setGPSSatellites(int var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.location.AMapLocationQualityReport::setGPSSatellites', {"var1": var1, "refId": refId});
   ...
   Future<bool> isWifiAble() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.location.AMapLocationQualityReport::isWifiAble', {"refId": refId});
   ...
   Future<int> getGPSStatus() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.location.AMapLocationQualityReport::getGPSStatus', {"refId": refId});
   ...
   Future<int> getGPSSatellites() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.location.AMapLocationQualityReport::getGPSSatellites', {"refId": refId});
   ...
   Future<String> getNetworkType() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.location.AMapLocationQualityReport::getNetworkType', {"refId": refId});
   ...
   Future<void> setNetworkType(String var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.location.AMapLocationQualityReport::setNetworkType', {"var1": var1, "refId": refId});
   ...
   Future<int> getNetUseTime() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.location.AMapLocationQualityReport::getNetUseTime', {"refId": refId});
   ...
   Future<void> setNetUseTime(int var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.location.AMapLocationQualityReport::setNetUseTime', {"var1": var1, "refId": refId});
   ...
   Future<void> setInstallHighDangerMockApp(bool var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.location.AMapLocationQualityReport::setInstallHighDangerMockApp', {"var1": var1, "refId": refId});
   ...
   Future<bool> isInstalledHighDangerMockApp() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.location.AMapLocationQualityReport::isInstalledHighDangerMockApp', {"refId": refId});
   ...
   Future<void> setLocationMode(com_amap_api_location_AMapLocationClientOption_AMapLocationMode var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.location.AMapLocationQualityReport::setLocationMode', {"var1": var1.index, "refId": refId});
   ...
   Future<String> getAdviseMessage() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.location.AMapLocationQualityReport::getAdviseMessage', {"refId": refId});
