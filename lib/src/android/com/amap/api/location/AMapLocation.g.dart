...
class com_amap_api_location_AMapLocation extends android_location_Location with android_os_Parcelable {
  ...
  Future<com_amap_api_location_AMapLocationQualityReport> getLocationQualityReport() async {
    ...
    if (result == null) {
      ...
      kNativeObjectPool.add(com_amap_api_location_AMapLocationQualityReport()..refId = result..tag = 'amap_search_fluttify');
      return com_amap_api_location_AMapLocationQualityReport()..refId = result..tag = 'amap_search_fluttify';
    }
  }
