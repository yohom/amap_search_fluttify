...
class com_amap_api_location_UmidtokenInfo extends java_lang_Object  {
  ...
  static Future<String> getUmidtoken() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.location.UmidtokenInfo::getUmidtoken', );
  ...
  static Future<void> setLocAble(bool var0) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.location.UmidtokenInfo::setLocAble', {"var0": var0});
  ...
  static Future<void> setUmidtoken(android_content_Context var0, String var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.location.UmidtokenInfo::setUmidtoken', {"var0": var0.refId, "var1": var1});
