...
class com_amap_api_location_CoordUtil extends java_lang_Object  {
  ...
  static Future<int> convertToGcj(List<double> var0, List<double> var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.location.CoordUtil::convertToGcj', {"var0": var0, "var1": var1});
  ...
  static Future<bool> isLoadedSo() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.location.CoordUtil::isLoadedSo', );
  ...
  static Future<void> setLoadedSo(bool var0) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.location.CoordUtil::setLoadedSo', {"var0": var0});
