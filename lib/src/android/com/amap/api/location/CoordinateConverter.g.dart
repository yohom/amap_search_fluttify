...
class com_amap_api_location_CoordinateConverter extends java_lang_Object  {
  ...
  Future<com_amap_api_location_CoordinateConverter> from(com_amap_api_location_CoordinateConverter_CoordType var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.location.CoordinateConverter::from', {"var1": var1.index, "refId": refId});
    ...
    if (result == null) {
      ...
      kNativeObjectPool.add(com_amap_api_location_CoordinateConverter()..refId = result);
  ...
  Future<com_amap_api_location_CoordinateConverter> coord(com_amap_api_location_DPoint var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.location.CoordinateConverter::coord', {"var1": var1.refId, "refId": refId});
  ...
  Future<com_amap_api_location_DPoint> convert() async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.location.CoordinateConverter::convert', {"refId": refId});
  ...
  static Future<bool> isAMapDataAvailable(double var0, double var2) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.location.CoordinateConverter::isAMapDataAvailable', {"var0": var0, "var2": var2});
  ...
  static Future<double> calculateLineDistance(com_amap_api_location_DPoint var0, com_amap_api_location_DPoint var1) async {
    ...
    // 调用原生方法
    final result = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.location.CoordinateConverter::calculateLineDistance', {"var0": var0.refId, "var1": var1.refId});
