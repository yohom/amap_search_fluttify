...
class com_amap_api_services_district_DistrictItem extends Ref_Android  {
  ...
  // 生成方法们
   ...
   Future<List<com_amap_api_services_district_DistrictItem>> getSubDistrict() async {
    ...
    // 返回值
    return (result as List).map((it) => com_amap_api_services_district_DistrictItem()..refId = it);
  }
