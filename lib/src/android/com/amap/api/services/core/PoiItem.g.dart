...
class com_amap_api_services_core_PoiItem extends java_lang_Object with android_os_Parcelable {
  ...
  Future<List<com_amap_api_services_poisearch_SubPoiItem>> getSubPois() async {
    ...
    if (result == null) {
      ...
      kNativeObjectPool.addAll((result as List).cast<int>().map((it) => com_amap_api_services_poisearch_SubPoiItem()..refId = it).toList());
  ...
  Future<com_amap_api_services_poisearch_IndoorData> getIndoorData() async {
    ...
    if (result == null) {
      ...
      kNativeObjectPool.add(com_amap_api_services_poisearch_IndoorData()..refId = result);
  ...
  Future<List<com_amap_api_services_poisearch_Photo>> getPhotos() async {
    ...
    if (result == null) {
      ...
      kNativeObjectPool.addAll((result as List).cast<int>().map((it) => com_amap_api_services_poisearch_Photo()..refId = it).toList());
  ...
  Future<com_amap_api_services_poisearch_PoiItemExtension> getPoiExtension() async {
    ...
    if (result == null) {
      ...
      kNativeObjectPool.add(com_amap_api_services_poisearch_PoiItemExtension()..refId = result);
