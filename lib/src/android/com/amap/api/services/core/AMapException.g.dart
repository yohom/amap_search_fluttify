...
class com_amap_api_services_core_AMapException extends java_lang_Object  {
  ...
  static Future<List<com_amap_api_services_core_AMapException>> create_batch__String(List<String> var1) async {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('ObjectFactory::create_batchcom_amap_api_services_core_AMapException__String', [for (int __i__ = 0; __i__ < var1.length; __i__++) {"var1": var1[__i__]}]);
  ...
  static Future<List<com_amap_api_services_core_AMapException>> create_batch__String__int__String(List<String> var1, List<int> var2, List<String> var3) async {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('ObjectFactory::create_batchcom_amap_api_services_core_AMapException__String__int__String', [for (int __i__ = 0; __i__ < var1.length; __i__++) {"var1": var1[__i__], "var2": var2[__i__], "var3": var3[__i__]}]);
  ...
  Future<int> getErrorLevel() async {
    ...
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.core.AMapException::getErrorLevel', {"refId": refId});
  ...
  Future<String> getErrorType() async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.core.AMapException::getErrorType', {"refId": refId});
  ...
  Future<String> getErrorMessage() async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.core.AMapException::getErrorMessage', {"refId": refId});
  ...
  Future<int> getErrorCode() async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.core.AMapException::getErrorCode', {"refId": refId});
...
extension com_amap_api_services_core_AMapException_Batch on List<com_amap_api_services_core_AMapException> {
  ...
  Future<List<int>> getErrorLevel_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.core.AMapException::getErrorLevel_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"refId": this[__i__].refId}]);
  ...
  Future<List<String>> getErrorType_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.core.AMapException::getErrorType_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"refId": this[__i__].refId}]);
  ...
  Future<List<String>> getErrorMessage_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.core.AMapException::getErrorMessage_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"refId": this[__i__].refId}]);
  ...
  Future<List<int>> getErrorCode_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.core.AMapException::getErrorCode_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"refId": this[__i__].refId}]);
