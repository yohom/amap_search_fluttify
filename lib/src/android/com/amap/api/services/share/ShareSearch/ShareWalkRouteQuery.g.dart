...
class com_amap_api_services_share_ShareSearch_ShareWalkRouteQuery extends java_lang_Object  {
  ...
  static Future<List<com_amap_api_services_share_ShareSearch_ShareWalkRouteQuery>> create_batch__com_amap_api_services_share_ShareSearch_ShareFromAndTo__int(List<com_amap_api_services_share_ShareSearch_ShareFromAndTo> var1, List<int> var2) async {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('ObjectFactory::create_batchcom_amap_api_services_share_ShareSearch_ShareWalkRouteQuery__com_amap_api_services_share_ShareSearch_ShareFromAndTo__int', [for (int i = 0; i < var1.length; i++) {"var1": var1[i].refId, "var2": var2[i]}]);
  
    final List<com_amap_api_services_share_ShareSearch_ShareWalkRouteQuery> typedResult = resultBatch.map((result) => com_amap_api_services_share_ShareSearch_ShareWalkRouteQuery()..refId = result..tag = 'amap_search_fluttify').toList();
...
extension com_amap_api_services_share_ShareSearch_ShareWalkRouteQuery_Batch on List<com_amap_api_services_share_ShareSearch_ShareWalkRouteQuery> {
  ...
  Future<List<int>> getWalkMode_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.share.ShareSearch.ShareWalkRouteQuery::getWalkMode_batch', [for (int i = 0; i < this.length; i++) {"refId": this[i].refId}]);
  ...
  Future<List<com_amap_api_services_share_ShareSearch_ShareFromAndTo>> getShareFromAndTo_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.share.ShareSearch.ShareWalkRouteQuery::getShareFromAndTo_batch', [for (int i = 0; i < this.length; i++) {"refId": this[i].refId}]);
