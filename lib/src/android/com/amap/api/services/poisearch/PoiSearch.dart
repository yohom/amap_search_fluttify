...
class com_amap_api_services_poisearch_PoiSearch extends Ref_Android  {
  ...
  Future<void> setOnPoiSearchListener(com_amap_api_services_poisearch_PoiSearch_OnPoiSearchListener var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.poisearch.PoiSearch::setOnPoiSearchListener', {"refId": refId});
  ...
  Future<void> setLanguage(String var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.poisearch.PoiSearch::setLanguage', {"var1": var1, "refId": refId});
  ...
  Future<String> getLanguage() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.poisearch.PoiSearch::getLanguage', {"refId": refId});
  ...
  Future<com_amap_api_services_poisearch_PoiResult> searchPOI() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.poisearch.PoiSearch::searchPOI', {"refId": refId});
  ...
  Future<void> searchPOIAsyn() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.poisearch.PoiSearch::searchPOIAsyn', {"refId": refId});
  ...
  Future<com_amap_api_services_core_PoiItem> searchPOIId(String var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.poisearch.PoiSearch::searchPOIId', {"var1": var1, "refId": refId});
  ...
  Future<void> searchPOIIdAsyn(String var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.poisearch.PoiSearch::searchPOIIdAsyn', {"var1": var1, "refId": refId});
  ...
  Future<void> setQuery(com_amap_api_services_poisearch_PoiSearch_Query var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.poisearch.PoiSearch::setQuery', {"var1": var1.refId, "refId": refId});
  ...
  Future<void> setBound(com_amap_api_services_poisearch_PoiSearch_SearchBound var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.poisearch.PoiSearch::setBound', {"var1": var1.refId, "refId": refId});
  ...
  Future<com_amap_api_services_poisearch_PoiSearch_Query> getQuery() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.poisearch.PoiSearch::getQuery', {"refId": refId});
  ...
  Future<com_amap_api_services_poisearch_PoiSearch_SearchBound> getBound() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.poisearch.PoiSearch::getBound', {"refId": refId});
