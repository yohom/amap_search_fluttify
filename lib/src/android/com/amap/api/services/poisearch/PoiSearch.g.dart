...
class com_amap_api_services_poisearch_PoiSearch extends java_lang_Object  {
  ...
  Future<void> setQuery(com_amap_api_services_poisearch_PoiSearch_Query var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.poisearch.PoiSearch::setQuery', {"var1": var1 is Ref ? (var1 as Ref)?.refId : var1, "refId": refId});
  ...
  Future<void> setBound(com_amap_api_services_poisearch_PoiSearch_SearchBound var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.poisearch.PoiSearch::setBound', {"var1": var1 is Ref ? (var1 as Ref)?.refId : var1, "refId": refId});
