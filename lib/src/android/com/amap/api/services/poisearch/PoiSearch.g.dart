...
class com_amap_api_services_poisearch_PoiSearch extends java_lang_Object  {
  ...
  static Future<com_amap_api_services_poisearch_PoiSearch> create__android_content_Context__com_amap_api_services_poisearch_PoiSearch_Query(android_content_Context var1, com_amap_api_services_poisearch_PoiSearch_Query var2) async {
    final refId = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::createcom_amap_api_services_poisearch_PoiSearch__android_content_Context__com_amap_api_services_poisearch_PoiSearch_Query', {"var1": var1, "var2": var2});
  ...
  static Future<List<com_amap_api_services_poisearch_PoiSearch>> create_batch__android_content_Context__com_amap_api_services_poisearch_PoiSearch_Query(List<android_content_Context> var1, List<com_amap_api_services_poisearch_PoiSearch_Query> var2) async {
    ...
    final List resultBatch = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::create_batchcom_amap_api_services_poisearch_PoiSearch__android_content_Context__com_amap_api_services_poisearch_PoiSearch_Query', [for (int __i__ = 0; __i__ < var1.length; __i__++) {"var1": var1[__i__], "var2": var2[__i__]}]);
  ...
  Future<com_amap_api_services_poisearch_PoiResult> searchPOI() async {
    ...
    if (__result__ == null) {
      ...
      final __return__ = __result__ == null ? null : (com_amap_api_services_poisearch_PoiResult()..refId = __result__);
      return __return__;
    }
  }
  ...
  Future<com_amap_api_services_core_PoiItem> searchPOIId(String var1) async {
    ...
    if (__result__ == null) {
      ...
      final __return__ = __result__ == null ? null : (com_amap_api_services_core_PoiItem()..refId = __result__);
      return __return__;
    }
  }
...
extension com_amap_api_services_poisearch_PoiSearch_Batch on List<com_amap_api_services_poisearch_PoiSearch> {
  ...
  Future<List<com_amap_api_services_poisearch_PoiResult>> searchPOI_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<String>().map((__result__) => __result__ == null ? null : (com_amap_api_services_poisearch_PoiResult()..refId = __result__)).toList();
      return typedResult;
    }
  }
  ...
  Future<List<com_amap_api_services_core_PoiItem>> searchPOIId_batch(List<String> var1) async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<String>().map((__result__) => __result__ == null ? null : (com_amap_api_services_core_PoiItem()..refId = __result__)).toList();
      return typedResult;
    }
  }
