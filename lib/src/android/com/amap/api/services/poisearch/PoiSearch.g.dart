...
extension com_amap_api_services_poisearch_PoiSearch_Batch on List<com_amap_api_services_poisearch_PoiSearch> {
  ...
  Future<List<com_amap_api_services_poisearch_PoiResult>> searchPOI_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((__result__) => com_amap_api_services_poisearch_PoiResult()..refId = __result__..tag__ = 'amap_search_fluttify').toList();
      kNativeObjectPool.addAll(typedResult);
      return typedResult;
    }
  }
  ...
  Future<List<com_amap_api_services_core_PoiItem>> searchPOIId_batch(List<String> var1) async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((__result__) => com_amap_api_services_core_PoiItem()..refId = __result__..tag__ = 'amap_search_fluttify').toList();
      kNativeObjectPool.addAll(typedResult);
      return typedResult;
    }
  }
  ...
  Future<List<com_amap_api_services_poisearch_PoiSearch_SearchBound>> getBound_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((__result__) => com_amap_api_services_poisearch_PoiSearch_SearchBound()..refId = __result__..tag__ = 'amap_search_fluttify').toList();
      kNativeObjectPool.addAll(typedResult);
      return typedResult;
    }
  }
