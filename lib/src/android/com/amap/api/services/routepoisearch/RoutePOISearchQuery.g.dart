...
extension com_amap_api_services_routepoisearch_RoutePOISearchQuery_Batch on List<com_amap_api_services_routepoisearch_RoutePOISearchQuery> {
  ...
  Future<List<com_amap_api_services_routepoisearch_RoutePOISearch_RoutePOISearchType>> getSearchType_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((__result__) => com_amap_api_services_routepoisearch_RoutePOISearch_RoutePOISearchType.values[__result__]).toList();
  ...
  Future<List<com_amap_api_services_routepoisearch_RoutePOISearchQuery>> clone_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((__result__) => com_amap_api_services_routepoisearch_RoutePOISearchQuery()..refId = __result__..tag__ = 'amap_search_fluttify').toList();
      kNativeObjectPool.addAll(typedResult);
      return typedResult;
    }
  }
