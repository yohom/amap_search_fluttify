...
class com_amap_api_services_traffic_TrafficStatusResult extends java_lang_Object with android_os_Parcelable {
  ...
  Future<void> setRoads(List<com_amap_api_services_traffic_TrafficStatusInfo> var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.traffic.TrafficStatusResult::setRoads', {"var1": var1.map((it) => it.refId).toList(), "refId": refId});
...
extension com_amap_api_services_traffic_TrafficStatusResult_Batch on List<com_amap_api_services_traffic_TrafficStatusResult> {
  ...
  Future<List<com_amap_api_services_traffic_TrafficStatusEvaluation>> getEvaluation_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((__result__) => com_amap_api_services_traffic_TrafficStatusEvaluation()..refId = __result__..tag__ = 'amap_search_fluttify').toList();
      kNativeObjectPool.addAll(typedResult);
      return typedResult;
    }
  }
  ...
  Future<List<List<com_amap_api_services_traffic_TrafficStatusInfo>>> getRoads_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((__result__) => (__result__ as List).cast<int>().map((__it__) => com_amap_api_services_traffic_TrafficStatusInfo()..refId = __it__..tag__ = 'amap_search_fluttify').toList()).toList();
