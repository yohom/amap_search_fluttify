...
class com_amap_api_services_traffic_TrafficStatusResult extends java_lang_Object with android_os_Parcelable {
  ...
  Future<com_amap_api_services_traffic_TrafficStatusEvaluation> getEvaluation() async {
    ...
    if (__result__ == null) {
      ...
      final __return__ = __result__ == null ? null : (com_amap_api_services_traffic_TrafficStatusEvaluation()..refId = __result__);
      return __return__;
    }
  }
  ...
  Future<List<com_amap_api_services_traffic_TrafficStatusInfo>> getRoads() async {
    ...
    if (__result__ == null) {
      ...
      final __return__ = (__result__ as List)?.cast<String>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_traffic_TrafficStatusInfo()..refId = __it__))?.toList();
      return __return__;
    }
  }
...
extension com_amap_api_services_traffic_TrafficStatusResult_Batch on List<com_amap_api_services_traffic_TrafficStatusResult> {
  ...
  Future<List<com_amap_api_services_traffic_TrafficStatusEvaluation>> getEvaluation_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<String>().map((__result__) => __result__ == null ? null : (com_amap_api_services_traffic_TrafficStatusEvaluation()..refId = __result__)).toList();
      return typedResult;
    }
  }
  ...
  Future<List<List<com_amap_api_services_traffic_TrafficStatusInfo>>> getRoads_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<String>().map((__result__) => (__result__ as List)?.cast<String>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_traffic_TrafficStatusInfo()..refId = __it__))?.toList()).toList();
      return typedResult;
    }
  }
