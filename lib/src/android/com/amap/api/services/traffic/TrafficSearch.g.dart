...
class com_amap_api_services_traffic_TrafficSearch extends java_lang_Object  {
  ...
  static Future<com_amap_api_services_traffic_TrafficSearch> create__android_content_Context(android_content_Context var1) async {
    final __result__ = await kAmapSearchFluttifyChannel.invokeMethod<Ref>('ObjectFactory::createcom_amap_api_services_traffic_TrafficSearch__android_content_Context', {"var1": var1});
    final object = com_amap_api_services_traffic_TrafficSearch()..refId = __result__.refId;
    return object;
  }
  ...
  static Future<List<com_amap_api_services_traffic_TrafficSearch>> create_batch__android_content_Context(List<android_content_Context> var1) async {
    ...
    final resultBatch = await kAmapSearchFluttifyChannel.invokeListMethod<Ref>('ObjectFactory::create_batchcom_amap_api_services_traffic_TrafficSearch__android_content_Context', [for (int __i__ = 0; __i__ < var1.length; __i__++) {"var1": var1[__i__]}]);
    return resultBatch.map((it) => com_amap_api_services_traffic_TrafficSearch()..refId = it.refId).toList();
  }
  ...
  Future<com_amap_api_services_traffic_TrafficStatusResult> loadTrafficByRoad(com_amap_api_services_traffic_RoadTrafficQuery var1) async {
    ...
    return __result__ == null ? null : (com_amap_api_services_traffic_TrafficStatusResult()..refId = __result__.refId);
  }
...
extension com_amap_api_services_traffic_TrafficSearch_Batch on List<com_amap_api_services_traffic_TrafficSearch> {
  ...
  Future<List<com_amap_api_services_traffic_TrafficStatusResult>> loadTrafficByRoad_batch(List<com_amap_api_services_traffic_RoadTrafficQuery> var1) async {
    ...
    return (resultBatch as List).cast<Ref>().map((__result__) => __result__ == null ? null : (com_amap_api_services_traffic_TrafficStatusResult()..refId = __result__.refId)).toList();
  }
