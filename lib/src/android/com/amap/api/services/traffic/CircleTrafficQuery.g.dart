...
class com_amap_api_services_traffic_CircleTrafficQuery extends java_lang_Object with android_os_Parcelable {
  ...
  static Future<com_amap_api_services_traffic_CircleTrafficQuery> create__com_amap_api_services_core_LatLonPoint__int__int(com_amap_api_services_core_LatLonPoint var1, int var2, int var3) async {
    final refId = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::createcom_amap_api_services_traffic_CircleTrafficQuery__com_amap_api_services_core_LatLonPoint__int__int', {"var1": var1, "var2": var2, "var3": var3});
  ...
  static Future<List<com_amap_api_services_traffic_CircleTrafficQuery>> create_batch__com_amap_api_services_core_LatLonPoint__int__int(List<com_amap_api_services_core_LatLonPoint> var1, List<int> var2, List<int> var3) async {
    ...
    final List resultBatch = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::create_batchcom_amap_api_services_traffic_CircleTrafficQuery__com_amap_api_services_core_LatLonPoint__int__int', [for (int __i__ = 0; __i__ < var1.length; __i__++) {"var1": var1[__i__], "var2": var2[__i__], "var3": var3[__i__]}]);
  
    final List<com_amap_api_services_traffic_CircleTrafficQuery> typedResult = resultBatch.map((result) => com_amap_api_services_traffic_CircleTrafficQuery()..refId = result).toList();
    return typedResult;
  }
  ...
  Future<com_amap_api_services_traffic_CircleTrafficQuery> clone() async {
    ...
    if (__result__ == null) {
      ...
      final __return__ = __result__ == null ? null : (com_amap_api_services_traffic_CircleTrafficQuery()..refId = __result__);
      return __return__;
    }
  }
...
extension com_amap_api_services_traffic_CircleTrafficQuery_Batch on List<com_amap_api_services_traffic_CircleTrafficQuery> {
  ...
  Future<List<com_amap_api_services_traffic_CircleTrafficQuery>> clone_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<String>().map((__result__) => __result__ == null ? null : (com_amap_api_services_traffic_CircleTrafficQuery()..refId = __result__)).toList();
      return typedResult;
    }
  }
