...
class com_amap_api_services_traffic_RoadTrafficQuery extends java_lang_Object with android_os_Parcelable {
  ...
  static Future<com_amap_api_services_traffic_RoadTrafficQuery> create__String__String__int(String var1, String var2, int var3) async {
    ...
    return AmapSearchFluttifyAndroidAs<com_amap_api_services_traffic_RoadTrafficQuery>(__result__);
  }
  ...
  static Future<List<com_amap_api_services_traffic_RoadTrafficQuery>> create_batch__String__String__int(List<String> var1, List<String> var2, List<int> var3) async {
    ...
    final __result_batch__ = await  kAmapSearchFluttifyChannel.invokeListMethod(
      'ObjectFactory::create_batchcom_amap_api_services_traffic_RoadTrafficQuery__String__String__int',
      [for (int __i__ = 0; __i__ < var1.length; __i__++) {"var1": var1[__i__], "var2": var2[__i__], "var3": var3[__i__]}]
    );
    return __result_batch__
        .map((it) => AmapSearchFluttifyAndroidAs<com_amap_api_services_traffic_RoadTrafficQuery>(it))
        .toList();
  }
...
extension com_amap_api_services_traffic_RoadTrafficQuery_Batch on List<com_amap_api_services_traffic_RoadTrafficQuery> {
  ...
  Future<List<com_amap_api_services_traffic_RoadTrafficQuery>> clone_batch() async {
    ...
    return (resultBatch as List).map((__result__) => AmapSearchFluttifyAndroidAs<com_amap_api_services_traffic_RoadTrafficQuery>(__result__)).cast<com_amap_api_services_traffic_RoadTrafficQuery>().toList();
  }
