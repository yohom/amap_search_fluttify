...
class com_amap_api_services_traffic_TrafficStatusInfo extends java_lang_Object with android_os_Parcelable {
  ...
  static Future<com_amap_api_services_traffic_TrafficStatusInfo> create__() async {
    final refId = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::createcom_amap_api_services_traffic_TrafficStatusInfo__', );
  ...
  static Future<List<com_amap_api_services_traffic_TrafficStatusInfo>> create_batch__(int length) async {
    ...
    final List resultBatch = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::create_batchcom_amap_api_services_traffic_TrafficStatusInfo__', {'length': length});
