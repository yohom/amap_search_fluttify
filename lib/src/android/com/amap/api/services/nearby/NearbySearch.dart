...
class com_amap_api_services_nearby_NearbySearch extends Ref_Android  {
  ...
  static Future<com_amap_api_services_nearby_NearbySearch> getInstance(android_content_Context var0) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.nearby.NearbySearch::getInstance', {"var0": var0.refId});
   ...
   Future<void> addNearbyListener(com_amap_api_services_nearby_NearbySearch_NearbyListener var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.nearby.NearbySearch::addNearbyListener', {"refId": refId});
   ...
   Future<void> removeNearbyListener(com_amap_api_services_nearby_NearbySearch_NearbyListener var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.nearby.NearbySearch::removeNearbyListener', {"refId": refId});
   ...
   Future<void> clearUserInfoAsyn() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.nearby.NearbySearch::clearUserInfoAsyn', {"refId": refId});
   ...
   Future<void> setUserID(String var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.nearby.NearbySearch::setUserID', {"var1": var1, "refId": refId});
   ...
   Future<void> startUploadNearbyInfoAuto(com_amap_api_services_nearby_UploadInfoCallback var1, int var2) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.nearby.NearbySearch::startUploadNearbyInfoAuto', {"var2": var2, "refId": refId});
   ...
   Future<void> stopUploadNearbyInfoAuto() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.nearby.NearbySearch::stopUploadNearbyInfoAuto', {"refId": refId});
   ...
   Future<void> uploadNearbyInfoAsyn(com_amap_api_services_nearby_UploadInfo var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.nearby.NearbySearch::uploadNearbyInfoAsyn', {"var1": var1.refId, "refId": refId});
   ...
   Future<void> searchNearbyInfoAsyn(com_amap_api_services_nearby_NearbySearch_NearbyQuery var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.nearby.NearbySearch::searchNearbyInfoAsyn', {"var1": var1.refId, "refId": refId});
   ...
   Future<com_amap_api_services_nearby_NearbySearchResult> searchNearbyInfo(com_amap_api_services_nearby_NearbySearch_NearbyQuery var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.nearby.NearbySearch::searchNearbyInfo', {"var1": var1.refId, "refId": refId});
  ...
  static Future<void> destroy() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.nearby.NearbySearch::destroy', );
