...
class com_amap_api_services_nearby_NearbySearchResult extends java_lang_Object  {
  ...
  Future<void> setNearbyInfoList(List<com_amap_api_services_nearby_NearbyInfo> var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.nearby.NearbySearchResult::setNearbyInfoList', {"var1": var1.map((it) => it.refId).toList(), "refId": refId});
...
extension com_amap_api_services_nearby_NearbySearchResult_Batch on List<com_amap_api_services_nearby_NearbySearchResult> {
  ...
  Future<List<List<com_amap_api_services_nearby_NearbyInfo>>> getNearbyInfoList_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((__result__) => (__result__ as List).cast<int>().map((__it__) => com_amap_api_services_nearby_NearbyInfo()..refId = __it__..tag__ = 'amap_search_fluttify').toList()).toList();
