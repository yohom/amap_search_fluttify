...
class com_amap_api_services_nearby_NearbyInfo extends java_lang_Object  {
  ...
  Future<void> setPoint(com_amap_api_services_core_LatLonPoint var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.nearby.NearbyInfo::setPoint', {"var1": var1 is Ref ? (var1 as Ref)?.refId : var1, "refId": refId});
