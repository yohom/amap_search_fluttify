...
class com_amap_api_services_nearby_NearbyInfo extends java_lang_Object  {
  ...
  static Future<com_amap_api_services_nearby_NearbyInfo> create__() async {
    final __result__ = await kAmapSearchFluttifyChannel.invokeMethod<Ref>('ObjectFactory::createcom_amap_api_services_nearby_NearbyInfo__', );
    final object = com_amap_api_services_nearby_NearbyInfo()..refId = __result__.refId;
    return object;
  }
  ...
  static Future<List<com_amap_api_services_nearby_NearbyInfo>> create_batch__(int length) async {
    ...
    final resultBatch = await kAmapSearchFluttifyChannel.invokeListMethod<Ref>('ObjectFactory::create_batchcom_amap_api_services_nearby_NearbyInfo__', {'length': length});
    return resultBatch.map((it) => com_amap_api_services_nearby_NearbyInfo()..refId = it.refId).toList();
  }
