...
class com_amap_api_services_nearby_NearbyInfo extends java_lang_Object  {
  ...
  static Future<com_amap_api_services_nearby_NearbyInfo> create__() async {
    final refId = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::createcom_amap_api_services_nearby_NearbyInfo__', );
  ...
  static Future<List<com_amap_api_services_nearby_NearbyInfo>> create_batch__(int length) async {
    ...
    final List resultBatch = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::create_batchcom_amap_api_services_nearby_NearbyInfo__', {'length': length});
