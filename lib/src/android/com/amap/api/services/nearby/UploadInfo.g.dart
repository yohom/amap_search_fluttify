...
class com_amap_api_services_nearby_UploadInfo extends java_lang_Object  {
  ...
  static Future<com_amap_api_services_nearby_UploadInfo> create__() async {
    final refId = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::createcom_amap_api_services_nearby_UploadInfo__', );
  ...
  static Future<List<com_amap_api_services_nearby_UploadInfo>> create_batch__(int length) async {
    ...
    final List resultBatch = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::create_batchcom_amap_api_services_nearby_UploadInfo__', {'length': length});
  
    final List<com_amap_api_services_nearby_UploadInfo> typedResult = resultBatch.map((result) => com_amap_api_services_nearby_UploadInfo()..refId = result).toList();
    return typedResult;
  }
