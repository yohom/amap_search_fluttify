...
class com_amap_api_services_nearby_UploadInfo extends java_lang_Object  {
  ...
  static Future<com_amap_api_services_nearby_UploadInfo> create__() async {
    final __result__ = await kAmapSearchFluttifyChannel.invokeMethod<Ref>('ObjectFactory::createcom_amap_api_services_nearby_UploadInfo__', );
    final object = com_amap_api_services_nearby_UploadInfo()..refId = __result__.refId;
    return object;
  }
  ...
  static Future<List<com_amap_api_services_nearby_UploadInfo>> create_batch__(int length) async {
    ...
    final resultBatch = await kAmapSearchFluttifyChannel.invokeListMethod<Ref>('ObjectFactory::create_batchcom_amap_api_services_nearby_UploadInfo__', {'length': length});
    return resultBatch.map((it) => com_amap_api_services_nearby_UploadInfo()..refId = it.refId).toList();
  }
