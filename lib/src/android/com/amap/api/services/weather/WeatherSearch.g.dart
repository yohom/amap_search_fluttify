...
class com_amap_api_services_weather_WeatherSearch extends java_lang_Object  {
  ...
  Future<void> setQuery(com_amap_api_services_weather_WeatherSearchQuery var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.weather.WeatherSearch::setQuery', {"var1": var1 is Ref ? (var1 as Ref)?.refId : var1, "refId": refId});
