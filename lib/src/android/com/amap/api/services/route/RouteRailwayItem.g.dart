...
class com_amap_api_services_route_RouteRailwayItem extends com_amap_api_services_route_Railway with android_os_Parcelable {
  ...
  static Future<com_amap_api_services_route_RouteRailwayItem> create__() async {
    final refId = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::createcom_amap_api_services_route_RouteRailwayItem__', );
  ...
  static Future<List<com_amap_api_services_route_RouteRailwayItem>> create_batch__(int length) async {
    ...
    final List resultBatch = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::create_batchcom_amap_api_services_route_RouteRailwayItem__', {'length': length});
  ...
  Future<com_amap_api_services_route_RailwayStationItem> getDeparturestop() async {
    ...
    if (__result__ == null) {
      ...
      final __return__ = __result__ == null ? null : (com_amap_api_services_route_RailwayStationItem()..refId = __result__);
      return __return__;
    }
  }
  ...
  Future<List<com_amap_api_services_route_RailwayStationItem>> getViastops() async {
    ...
    if (__result__ == null) {
      ...
      final __return__ = (__result__ as List)?.cast<String>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_route_RailwayStationItem()..refId = __it__))?.toList();
      return __return__;
    }
  }
  ...
  Future<List<com_amap_api_services_route_Railway>> getAlters() async {
    ...
    if (__result__ == null) {
      ...
      final __return__ = (__result__ as List)?.cast<String>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_route_Railway()..refId = __it__))?.toList();
      return __return__;
    }
  }
  ...
  Future<List<com_amap_api_services_route_RailwaySpace>> getSpaces() async {
    ...
    if (__result__ == null) {
      ...
      final __return__ = (__result__ as List)?.cast<String>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_route_RailwaySpace()..refId = __it__))?.toList();
      return __return__;
    }
  }
...
extension com_amap_api_services_route_RouteRailwayItem_Batch on List<com_amap_api_services_route_RouteRailwayItem> {
  ...
  Future<List<com_amap_api_services_route_RailwayStationItem>> getDeparturestop_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<String>().map((__result__) => __result__ == null ? null : (com_amap_api_services_route_RailwayStationItem()..refId = __result__)).toList();
      return typedResult;
    }
  }
  ...
  Future<List<List<com_amap_api_services_route_RailwayStationItem>>> getViastops_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<String>().map((__result__) => (__result__ as List)?.cast<String>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_route_RailwayStationItem()..refId = __it__))?.toList()).toList();
      return typedResult;
    }
  }
  ...
  Future<List<List<com_amap_api_services_route_Railway>>> getAlters_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<String>().map((__result__) => (__result__ as List)?.cast<String>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_route_Railway()..refId = __it__))?.toList()).toList();
      return typedResult;
    }
  }
  ...
  Future<List<List<com_amap_api_services_route_RailwaySpace>>> getSpaces_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<String>().map((__result__) => (__result__ as List)?.cast<String>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_route_RailwaySpace()..refId = __it__))?.toList()).toList();
      return typedResult;
    }
  }
