...
class com_amap_api_services_route_RoutePlanResult extends java_lang_Object with android_os_Parcelable {
  ...
  static Future<List<com_amap_api_services_route_RoutePlanResult>> create_batch__(int length) async {
    ...
    final List<com_amap_api_services_route_RoutePlanResult> typedResult = resultBatch.map((result) => com_amap_api_services_route_RoutePlanResult()..refId = result..tag = 'amap_search_fluttify').toList();
...
extension com_amap_api_services_route_RoutePlanResult_Batch on List<com_amap_api_services_route_RoutePlanResult> {
  ...
  Future<List<com_amap_api_services_core_LatLonPoint>> getStartPos_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.route.RoutePlanResult::getStartPos_batch', [for (int i = 0; i < this.length; i++) {"refId": this[i].refId}]);
  ...
  Future<void> setStartPos_batch(List<com_amap_api_services_core_LatLonPoint> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.route.RoutePlanResult::setStartPos_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i].refId, "refId": this[i].refId}]);
  ...
  Future<List<com_amap_api_services_core_LatLonPoint>> getTargetPos_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.route.RoutePlanResult::getTargetPos_batch', [for (int i = 0; i < this.length; i++) {"refId": this[i].refId}]);
  ...
  Future<void> setTargetPos_batch(List<com_amap_api_services_core_LatLonPoint> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.route.RoutePlanResult::setTargetPos_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i].refId, "refId": this[i].refId}]);
