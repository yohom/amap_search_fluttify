...
class com_amap_api_services_route_TMC extends java_lang_Object with android_os_Parcelable {
  ...
  static Future<com_amap_api_services_route_TMC> create__() async {
    final __result__ = await kAmapSearchFluttifyChannel.invokeMethod<Ref>('ObjectFactory::createcom_amap_api_services_route_TMC__', );
    final object = com_amap_api_services_route_TMC()..refId = __result__.refId;
    return object;
  }
  ...
  static Future<List<com_amap_api_services_route_TMC>> create_batch__(int length) async {
    ...
    final resultBatch = await kAmapSearchFluttifyChannel.invokeListMethod<Ref>('ObjectFactory::create_batchcom_amap_api_services_route_TMC__', {'length': length});
    return resultBatch.map((it) => com_amap_api_services_route_TMC()..refId = it.refId).toList();
  }
