...
class com_amap_api_services_route_WalkRouteResult extends com_amap_api_services_route_RouteResult with android_os_Parcelable {
  ...
  Future<List<com_amap_api_services_route_WalkPath>> getPaths() async {
    ...
    if (__result__ == null) {
      ...
      final __return__ = (__result__ as List).cast<int>().map((__it__) => com_amap_api_services_route_WalkPath()..refId = __it__..tag__ = 'amap_search_fluttify').toList();
  ...
  Future<void> setWalkQuery(com_amap_api_services_route_RouteSearch_WalkRouteQuery var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.route.WalkRouteResult::setWalkQuery', {"var1": var1 is Ref ? (var1 as Ref)?.refId : var1, "refId": refId});
