...
class com_amap_api_services_route_RouteBusLineItem extends com_amap_api_services_busline_BusLineItem with android_os_Parcelable {
  ...
  Future<com_amap_api_services_busline_BusStationItem> getDepartureBusStation() async {
    ...
    if (__result__ == null) {
      ...
      kNativeObjectPool.add(com_amap_api_services_busline_BusStationItem()..refId = __result__..tag__ = 'amap_search_fluttify');
      return com_amap_api_services_busline_BusStationItem()..refId = __result__..tag__ = 'amap_search_fluttify';
    }
  }
  ...
  Future<void> setPolyline(List<com_amap_api_services_core_LatLonPoint> var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.route.RouteBusLineItem::setPolyline', {"var1": var1.map((it) => it.refId).toList(), "refId": refId});
  ...
  Future<void> setPassStations(List<com_amap_api_services_busline_BusStationItem> var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.route.RouteBusLineItem::setPassStations', {"var1": var1.map((it) => it.refId).toList(), "refId": refId});
...
extension com_amap_api_services_route_RouteBusLineItem_Batch on List<com_amap_api_services_route_RouteBusLineItem> {
  ...
  Future<List<com_amap_api_services_busline_BusStationItem>> getDepartureBusStation_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((__result__) => com_amap_api_services_busline_BusStationItem()..refId = __result__..tag__ = 'amap_search_fluttify').toList();
      kNativeObjectPool.addAll(typedResult);
      return typedResult;
    }
  }
