...
class com_amap_api_services_route_RouteSearch_WalkRouteQuery extends java_lang_Object with android_os_Parcelable {
  ...
  static Future<com_amap_api_services_route_RouteSearch_WalkRouteQuery> create__com_amap_api_services_route_RouteSearch_FromAndTo__int(com_amap_api_services_route_RouteSearch_FromAndTo var1, int var2) async {
    final __result__ = await kAmapSearchFluttifyChannel.invokeMethod<Ref>('ObjectFactory::createcom_amap_api_services_route_RouteSearch_WalkRouteQuery__com_amap_api_services_route_RouteSearch_FromAndTo__int', {"var1": var1, "var2": var2});
    final object = com_amap_api_services_route_RouteSearch_WalkRouteQuery()..refId = __result__.refId;
    return object;
  }
  ...
  static Future<com_amap_api_services_route_RouteSearch_WalkRouteQuery> create__com_amap_api_services_route_RouteSearch_FromAndTo(com_amap_api_services_route_RouteSearch_FromAndTo var1) async {
    final __result__ = await kAmapSearchFluttifyChannel.invokeMethod<Ref>('ObjectFactory::createcom_amap_api_services_route_RouteSearch_WalkRouteQuery__com_amap_api_services_route_RouteSearch_FromAndTo', {"var1": var1});
    final object = com_amap_api_services_route_RouteSearch_WalkRouteQuery()..refId = __result__.refId;
    return object;
  }
  
  static Future<com_amap_api_services_route_RouteSearch_WalkRouteQuery> create__() async {
    final __result__ = await kAmapSearchFluttifyChannel.invokeMethod<Ref>('ObjectFactory::createcom_amap_api_services_route_RouteSearch_WalkRouteQuery__', );
    final object = com_amap_api_services_route_RouteSearch_WalkRouteQuery()..refId = __result__.refId;
    return object;
  }
  ...
  static Future<List<com_amap_api_services_route_RouteSearch_WalkRouteQuery>> create_batch__com_amap_api_services_route_RouteSearch_FromAndTo__int(List<com_amap_api_services_route_RouteSearch_FromAndTo> var1, List<int> var2) async {
    ...
    final resultBatch = await kAmapSearchFluttifyChannel.invokeListMethod<Ref>('ObjectFactory::create_batchcom_amap_api_services_route_RouteSearch_WalkRouteQuery__com_amap_api_services_route_RouteSearch_FromAndTo__int', [for (int __i__ = 0; __i__ < var1.length; __i__++) {"var1": var1[__i__], "var2": var2[__i__]}]);
    return resultBatch.map((it) => com_amap_api_services_route_RouteSearch_WalkRouteQuery()..refId = it.refId).toList();
  }
  ...
  static Future<List<com_amap_api_services_route_RouteSearch_WalkRouteQuery>> create_batch__com_amap_api_services_route_RouteSearch_FromAndTo(List<com_amap_api_services_route_RouteSearch_FromAndTo> var1) async {
    ...
    final resultBatch = await kAmapSearchFluttifyChannel.invokeListMethod<Ref>('ObjectFactory::create_batchcom_amap_api_services_route_RouteSearch_WalkRouteQuery__com_amap_api_services_route_RouteSearch_FromAndTo', [for (int __i__ = 0; __i__ < var1.length; __i__++) {"var1": var1[__i__]}]);
    return resultBatch.map((it) => com_amap_api_services_route_RouteSearch_WalkRouteQuery()..refId = it.refId).toList();
  }
  ...
  static Future<List<com_amap_api_services_route_RouteSearch_WalkRouteQuery>> create_batch__(int length) async {
    ...
    final resultBatch = await kAmapSearchFluttifyChannel.invokeListMethod<Ref>('ObjectFactory::create_batchcom_amap_api_services_route_RouteSearch_WalkRouteQuery__', {'length': length});
    return resultBatch.map((it) => com_amap_api_services_route_RouteSearch_WalkRouteQuery()..refId = it.refId).toList();
  }
  ...
  Future<com_amap_api_services_route_RouteSearch_WalkRouteQuery> clone() async {
    ...
    return __result__ == null ? null : (com_amap_api_services_route_RouteSearch_WalkRouteQuery()..refId = __result__.refId);
  }
...
extension com_amap_api_services_route_RouteSearch_WalkRouteQuery_Batch on List<com_amap_api_services_route_RouteSearch_WalkRouteQuery> {
  ...
  Future<List<com_amap_api_services_route_RouteSearch_WalkRouteQuery>> clone_batch() async {
    ...
    return (resultBatch as List).cast<Ref>().map((__result__) => __result__ == null ? null : (com_amap_api_services_route_RouteSearch_WalkRouteQuery()..refId = __result__.refId)).toList();
  }
