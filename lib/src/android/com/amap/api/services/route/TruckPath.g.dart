...
class com_amap_api_services_route_TruckPath extends java_lang_Object with android_os_Parcelable {
  ...
  Future<List<com_amap_api_services_route_TruckStep>> getSteps() async {
    ...
    if (__result__ == null) {
      ...
      final __return__ = (__result__ as List)?.cast<String>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_route_TruckStep()..refId = __it__))?.toList();
      return __return__;
    }
  }
...
extension com_amap_api_services_route_TruckPath_Batch on List<com_amap_api_services_route_TruckPath> {
  ...
  Future<List<List<com_amap_api_services_route_TruckStep>>> getSteps_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<String>().map((__result__) => (__result__ as List)?.cast<String>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_route_TruckStep()..refId = __it__))?.toList()).toList();
      return typedResult;
    }
  }
