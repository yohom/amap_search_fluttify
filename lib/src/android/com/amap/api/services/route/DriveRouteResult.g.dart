...
class com_amap_api_services_route_DriveRouteResult extends com_amap_api_services_route_RouteResult with android_os_Parcelable {
  ...
  static Future<com_amap_api_services_route_DriveRouteResult> create__() async {
    final refId = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::createcom_amap_api_services_route_DriveRouteResult__', );
  ...
  static Future<List<com_amap_api_services_route_DriveRouteResult>> create_batch__(int length) async {
    ...
    final List resultBatch = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::create_batchcom_amap_api_services_route_DriveRouteResult__', {'length': length});
  
    final List<com_amap_api_services_route_DriveRouteResult> typedResult = resultBatch.map((result) => com_amap_api_services_route_DriveRouteResult()..refId = result).toList();
    return typedResult;
  }
