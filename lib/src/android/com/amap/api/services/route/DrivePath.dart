...
class com_amap_api_services_route_DrivePath extends java_lang_Object  {
  ...
  Future<String> getStrategy() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.route.DrivePath::getStrategy', {"refId": refId});
  ...
  Future<void> setStrategy(String var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.route.DrivePath::setStrategy', {"var1": var1, "refId": refId});
  ...
  Future<double> getTolls() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.route.DrivePath::getTolls', {"refId": refId});
  ...
  Future<void> setTolls(double var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.route.DrivePath::setTolls', {"var1": var1, "refId": refId});
  ...
  Future<double> getTollDistance() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.route.DrivePath::getTollDistance', {"refId": refId});
  ...
  Future<void> setTollDistance(double var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.route.DrivePath::setTollDistance', {"var1": var1, "refId": refId});
  ...
  Future<int> getTotalTrafficlights() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.route.DrivePath::getTotalTrafficlights', {"refId": refId});
  ...
  Future<void> setTotalTrafficlights(int var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.route.DrivePath::setTotalTrafficlights', {"var1": var1, "refId": refId});
  ...
  Future<void> setSteps(List<com_amap_api_services_route_DriveStep> var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.route.DrivePath::setSteps', {"var1": var1.map((it) => it.refId).toList(), "refId": refId});
  ...
  Future<int> getRestriction() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.route.DrivePath::getRestriction', {"refId": refId});
  ...
  Future<void> setRestriction(int var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.route.DrivePath::setRestriction', {"var1": var1, "refId": refId});
