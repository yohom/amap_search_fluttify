...
class com_amap_api_services_route_RouteBusWalkItem extends com_amap_api_services_route_WalkPath with android_os_Parcelable {
  ...
  Future<void> setOrigin(com_amap_api_services_core_LatLonPoint var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.route.RouteBusWalkItem::setOrigin', {"var1": var1 is Ref ? (var1 as Ref)?.refId : var1, "refId": refId});
  ...
  Future<void> setDestination(com_amap_api_services_core_LatLonPoint var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.route.RouteBusWalkItem::setDestination', {"var1": var1 is Ref ? (var1 as Ref)?.refId : var1, "refId": refId});
