...
class com_amap_api_services_route_RouteBusWalkItem extends com_amap_api_services_route_WalkPath with android_os_Parcelable {
  ...
  static Future<com_amap_api_services_route_RouteBusWalkItem> create__() async {
    return kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::createcom_amap_api_services_route_RouteBusWalkItem__', );
  }
  ...
  static Future<List<com_amap_api_services_route_RouteBusWalkItem>> create_batch__(int length) async {
    ...
    return kAmapSearchFluttifyChannel.invokeListMethod<com_amap_api_services_route_RouteBusWalkItem>('ObjectFactory::create_batchcom_amap_api_services_route_RouteBusWalkItem__', {'length': length});
  }
