...
class com_amap_api_services_route_RidePath extends com_amap_api_services_route_Path with android_os_Parcelable {
  ...
  Future<List<com_amap_api_services_route_RideStep>> getSteps() async {
    ...
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.route.RidePath::getSteps', {"refId": refId});
    ...
    if (__result__ == null) {
      ...
      kNativeObjectPool.addAll((__result__ as List).cast<int>().map((__it__) => com_amap_api_services_route_RideStep()..refId = __it__..tag__ = 'amap_search_fluttify').toList());
      return (__result__ as List).cast<int>().map((__it__) => com_amap_api_services_route_RideStep()..refId = __it__..tag__ = 'amap_search_fluttify').toList();
    }
  }
...
extension com_amap_api_services_route_RidePath_Batch on List<com_amap_api_services_route_RidePath> {
  ...
  Future<List<List<com_amap_api_services_route_RideStep>>> getSteps_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.route.RidePath::getSteps_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"refId": this[__i__].refId}]);
  ...
  Future<void> setSteps_batch(List<List<com_amap_api_services_route_RideStep>> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.route.RidePath::setSteps_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__].map((it) => it.refId).toList(), "refId": this[__i__].refId}]);
