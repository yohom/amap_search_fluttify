...
class com_amap_api_services_route_RidePath extends com_amap_api_services_route_Path with android_os_Parcelable {
  ...
  static Future<com_amap_api_services_route_RidePath> create__() async {
    final refId = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::createcom_amap_api_services_route_RidePath__', );
  ...
  static Future<List<com_amap_api_services_route_RidePath>> create_batch__(int length) async {
    ...
    final List resultBatch = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::create_batchcom_amap_api_services_route_RidePath__', {'length': length});
