...
class com_amap_api_services_route_TruckRouteRestult extends java_lang_Object with android_os_Parcelable {
  ...
  static Future<com_amap_api_services_route_TruckRouteRestult> create__() async {
    final refId = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::createcom_amap_api_services_route_TruckRouteRestult__', );
  ...
  static Future<List<com_amap_api_services_route_TruckRouteRestult>> create_batch__(int length) async {
    ...
    final List resultBatch = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::create_batchcom_amap_api_services_route_TruckRouteRestult__', {'length': length});
  ...
  Future<List<com_amap_api_services_route_TruckPath>> getPaths() async {
    ...
    if (__result__ == null) {
      ...
      final __return__ = (__result__ as List)?.cast<String>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_route_TruckPath()..refId = __it__))?.toList();
      return __return__;
    }
  }
...
extension com_amap_api_services_route_TruckRouteRestult_Batch on List<com_amap_api_services_route_TruckRouteRestult> {
  ...
  Future<List<List<com_amap_api_services_route_TruckPath>>> getPaths_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<String>().map((__result__) => (__result__ as List)?.cast<String>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_route_TruckPath()..refId = __it__))?.toList()).toList();
      return typedResult;
    }
  }
