...
class com_amap_api_services_route_RouteSearch extends java_lang_Object  {
  ...
  static Future<com_amap_api_services_route_RouteSearch> create__android_content_Context(android_content_Context var1) async {
    final refId = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::createcom_amap_api_services_route_RouteSearch__android_content_Context', {"var1": var1});
  ...
  static Future<List<com_amap_api_services_route_RouteSearch>> create_batch__android_content_Context(List<android_content_Context> var1) async {
    ...
    final List resultBatch = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::create_batchcom_amap_api_services_route_RouteSearch__android_content_Context', [for (int __i__ = 0; __i__ < var1.length; __i__++) {"var1": var1[__i__]}]);
  ...
  Future<com_amap_api_services_route_WalkRouteResult> calculateWalkRoute(com_amap_api_services_route_RouteSearch_WalkRouteQuery var1) async {
    ...
    if (__result__ == null) {
      ...
      final __return__ = __result__ == null ? null : (com_amap_api_services_route_WalkRouteResult()..refId = __result__);
      return __return__;
    }
  }
  ...
  Future<com_amap_api_services_route_BusRouteResult> calculateBusRoute(com_amap_api_services_route_RouteSearch_BusRouteQuery var1) async {
    ...
    if (__result__ == null) {
      ...
      final __return__ = __result__ == null ? null : (com_amap_api_services_route_BusRouteResult()..refId = __result__);
      return __return__;
    }
  }
  ...
  Future<com_amap_api_services_route_DriveRouteResult> calculateDriveRoute(com_amap_api_services_route_RouteSearch_DriveRouteQuery var1) async {
    ...
    if (__result__ == null) {
      ...
      final __return__ = __result__ == null ? null : (com_amap_api_services_route_DriveRouteResult()..refId = __result__);
      return __return__;
    }
  }
  ...
  Future<com_amap_api_services_route_RideRouteResult> calculateRideRoute(com_amap_api_services_route_RouteSearch_RideRouteQuery var1) async {
    ...
    if (__result__ == null) {
      ...
      final __return__ = __result__ == null ? null : (com_amap_api_services_route_RideRouteResult()..refId = __result__);
      return __return__;
    }
  }
  ...
  Future<com_amap_api_services_route_TruckRouteRestult> calculateTruckRoute(com_amap_api_services_route_RouteSearch_TruckRouteQuery var1) async {
    ...
    if (__result__ == null) {
      ...
      final __return__ = __result__ == null ? null : (com_amap_api_services_route_TruckRouteRestult()..refId = __result__);
      return __return__;
    }
  }
  ...
  Future<com_amap_api_services_route_DriveRoutePlanResult> calculateDrivePlan(com_amap_api_services_route_RouteSearch_DrivePlanQuery var1) async {
    ...
    if (__result__ == null) {
      ...
      final __return__ = __result__ == null ? null : (com_amap_api_services_route_DriveRoutePlanResult()..refId = __result__);
      return __return__;
    }
  }
...
extension com_amap_api_services_route_RouteSearch_Batch on List<com_amap_api_services_route_RouteSearch> {
  ...
  Future<List<com_amap_api_services_route_WalkRouteResult>> calculateWalkRoute_batch(List<com_amap_api_services_route_RouteSearch_WalkRouteQuery> var1) async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<String>().map((__result__) => __result__ == null ? null : (com_amap_api_services_route_WalkRouteResult()..refId = __result__)).toList();
      return typedResult;
    }
  }
  ...
  Future<List<com_amap_api_services_route_BusRouteResult>> calculateBusRoute_batch(List<com_amap_api_services_route_RouteSearch_BusRouteQuery> var1) async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<String>().map((__result__) => __result__ == null ? null : (com_amap_api_services_route_BusRouteResult()..refId = __result__)).toList();
      return typedResult;
    }
  }
  ...
  Future<List<com_amap_api_services_route_DriveRouteResult>> calculateDriveRoute_batch(List<com_amap_api_services_route_RouteSearch_DriveRouteQuery> var1) async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<String>().map((__result__) => __result__ == null ? null : (com_amap_api_services_route_DriveRouteResult()..refId = __result__)).toList();
      return typedResult;
    }
  }
  ...
  Future<List<com_amap_api_services_route_RideRouteResult>> calculateRideRoute_batch(List<com_amap_api_services_route_RouteSearch_RideRouteQuery> var1) async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<String>().map((__result__) => __result__ == null ? null : (com_amap_api_services_route_RideRouteResult()..refId = __result__)).toList();
      return typedResult;
    }
  }
  ...
  Future<List<com_amap_api_services_route_TruckRouteRestult>> calculateTruckRoute_batch(List<com_amap_api_services_route_RouteSearch_TruckRouteQuery> var1) async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<String>().map((__result__) => __result__ == null ? null : (com_amap_api_services_route_TruckRouteRestult()..refId = __result__)).toList();
      return typedResult;
    }
  }
  ...
  Future<List<com_amap_api_services_route_DriveRoutePlanResult>> calculateDrivePlan_batch(List<com_amap_api_services_route_RouteSearch_DrivePlanQuery> var1) async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<String>().map((__result__) => __result__ == null ? null : (com_amap_api_services_route_DriveRoutePlanResult()..refId = __result__)).toList();
      return typedResult;
    }
  }
