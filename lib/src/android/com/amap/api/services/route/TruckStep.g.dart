...
class com_amap_api_services_route_TruckStep extends java_lang_Object with android_os_Parcelable {
  ...
  static Future<com_amap_api_services_route_TruckStep> create__() async {
    final refId = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::createcom_amap_api_services_route_TruckStep__', );
  ...
  static Future<List<com_amap_api_services_route_TruckStep>> create_batch__(int length) async {
    ...
    final List resultBatch = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::create_batchcom_amap_api_services_route_TruckStep__', {'length': length});
  ...
  Future<List<com_amap_api_services_route_RouteSearchCity>> getRouteSearchCityList() async {
    ...
    if (__result__ == null) {
      ...
      final __return__ = (__result__ as List)?.cast<String>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_route_RouteSearchCity()..refId = __it__))?.toList();
      return __return__;
    }
  }
  ...
  Future<List<com_amap_api_services_route_TMC>> getTMCs() async {
    ...
    if (__result__ == null) {
      ...
      final __return__ = (__result__ as List)?.cast<String>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_route_TMC()..refId = __it__))?.toList();
      return __return__;
    }
  }
...
extension com_amap_api_services_route_TruckStep_Batch on List<com_amap_api_services_route_TruckStep> {
  ...
  Future<List<List<com_amap_api_services_route_RouteSearchCity>>> getRouteSearchCityList_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<String>().map((__result__) => (__result__ as List)?.cast<String>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_route_RouteSearchCity()..refId = __it__))?.toList()).toList();
      return typedResult;
    }
  }
  ...
  Future<List<List<com_amap_api_services_route_TMC>>> getTMCs_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<String>().map((__result__) => (__result__ as List)?.cast<String>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_route_TMC()..refId = __it__))?.toList()).toList();
      return typedResult;
    }
  }
