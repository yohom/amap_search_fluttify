...
class com_amap_api_services_route_DrivePlanPath extends java_lang_Object with android_os_Parcelable {
  ...
  Future<List<com_amap_api_services_route_DrivePlanStep>> getSteps() async {
    ...
    if (__result__ == null) {
      ...
      final __return__ = (__result__ as List).cast<int>().map((__it__) => com_amap_api_services_route_DrivePlanStep()..refId = __it__..tag__ = 'amap_search_fluttify').toList();
  ...
  Future<void> setSteps(List<com_amap_api_services_route_DrivePlanStep> var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.route.DrivePlanPath::setSteps', {"var1": var1.map((__it__) => __it__.refId).toList(), "refId": refId});
...
extension com_amap_api_services_route_DrivePlanPath_Batch on List<com_amap_api_services_route_DrivePlanPath> {
  ...
  Future<List<List<com_amap_api_services_route_DrivePlanStep>>> getSteps_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<int>().map((__result__) => (__result__ as List).cast<int>().map((__it__) => com_amap_api_services_route_DrivePlanStep()..refId = __it__..tag__ = 'amap_search_fluttify').toList()).toList();
