...
class com_amap_api_services_route_DriveRoutePlanResult extends com_amap_api_services_route_RoutePlanResult with android_os_Parcelable {
  ...
  static Future<com_amap_api_services_route_DriveRoutePlanResult> create__() async {
    final refId = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::createcom_amap_api_services_route_DriveRoutePlanResult__', );
  ...
  static Future<List<com_amap_api_services_route_DriveRoutePlanResult>> create_batch__(int length) async {
    ...
    final List resultBatch = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::create_batchcom_amap_api_services_route_DriveRoutePlanResult__', {'length': length});
  ...
  Future<List<com_amap_api_services_route_DrivePlanPath>> getPaths() async {
    ...
    if (__result__ == null) {
      ...
      final __return__ = (__result__ as List)?.cast<String>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_route_DrivePlanPath()..refId = __it__))?.toList();
      return __return__;
    }
  }
  ...
  Future<List<com_amap_api_services_route_TimeInfo>> getTimeInfos() async {
    ...
    if (__result__ == null) {
      ...
      final __return__ = (__result__ as List)?.cast<String>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_route_TimeInfo()..refId = __it__))?.toList();
      return __return__;
    }
  }
...
extension com_amap_api_services_route_DriveRoutePlanResult_Batch on List<com_amap_api_services_route_DriveRoutePlanResult> {
  ...
  Future<List<List<com_amap_api_services_route_DrivePlanPath>>> getPaths_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<String>().map((__result__) => (__result__ as List)?.cast<String>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_route_DrivePlanPath()..refId = __it__))?.toList()).toList();
      return typedResult;
    }
  }
  ...
  Future<List<List<com_amap_api_services_route_TimeInfo>>> getTimeInfos_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<String>().map((__result__) => (__result__ as List)?.cast<String>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_route_TimeInfo()..refId = __it__))?.toList()).toList();
      return typedResult;
    }
  }
