...
class com_amap_api_services_route_DriveRoutePlanResult extends com_amap_api_services_route_RoutePlanResult with android_os_Parcelable {
  ...
  static Future<com_amap_api_services_route_DriveRoutePlanResult> create__() async {
    final __result__ = await kAmapSearchFluttifyChannel.invokeMethod<Ref>('ObjectFactory::createcom_amap_api_services_route_DriveRoutePlanResult__', );
    final object = com_amap_api_services_route_DriveRoutePlanResult()..refId = __result__.refId;
    return object;
  }
  ...
  static Future<List<com_amap_api_services_route_DriveRoutePlanResult>> create_batch__(int length) async {
    ...
    final resultBatch = await kAmapSearchFluttifyChannel.invokeListMethod<Ref>('ObjectFactory::create_batchcom_amap_api_services_route_DriveRoutePlanResult__', {'length': length});
    return resultBatch.map((it) => com_amap_api_services_route_DriveRoutePlanResult()..refId = it.refId).toList();
  }
  ...
  Future<List<com_amap_api_services_route_DrivePlanPath>> getPaths() async {
    ...
    return (__result__ as List)?.cast<Ref>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_route_DrivePlanPath()..refId = __it__.refId))?.toList();
  }
  ...
  Future<List<com_amap_api_services_route_TimeInfo>> getTimeInfos() async {
    ...
    return (__result__ as List)?.cast<Ref>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_route_TimeInfo()..refId = __it__.refId))?.toList();
  }
...
extension com_amap_api_services_route_DriveRoutePlanResult_Batch on List<com_amap_api_services_route_DriveRoutePlanResult> {
  ...
  Future<List<List<com_amap_api_services_route_DrivePlanPath>>> getPaths_batch() async {
    ...
    return (resultBatch as List).cast<Ref>().map((__result__) => (__result__ as List)?.cast<Ref>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_route_DrivePlanPath()..refId = __it__.refId))?.toList()).toList();
  }
  ...
  Future<List<List<com_amap_api_services_route_TimeInfo>>> getTimeInfos_batch() async {
    ...
    return (resultBatch as List).cast<Ref>().map((__result__) => (__result__ as List)?.cast<Ref>()?.map((__it__) => __it__ == null ? null : (com_amap_api_services_route_TimeInfo()..refId = __it__.refId))?.toList()).toList();
  }
