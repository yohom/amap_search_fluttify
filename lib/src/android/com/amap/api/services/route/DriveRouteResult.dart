...
class com_amap_api_services_route_DriveRouteResult extends Ref_Android  {
  ...
  // 生成方法们
   ...
   Future<List<com_amap_api_services_route_DrivePath>> getPaths() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.route.DriveRouteResult::getPaths', {"refId": refId});
    ...
    // 返回值
    return (result as List).map((it) => com_amap_api_services_route_DrivePath()..refId = it);
  }
