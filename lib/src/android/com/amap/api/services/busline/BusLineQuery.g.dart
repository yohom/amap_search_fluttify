...
class com_amap_api_services_busline_BusLineQuery extends java_lang_Object  {
  ...
  Future<bool> weakEquals(com_amap_api_services_busline_BusLineQuery var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('com.amap.api.services.busline.BusLineQuery::weakEquals', {"var1": var1 is Ref ? (var1 as Ref)?.refId : var1, "refId": refId});
