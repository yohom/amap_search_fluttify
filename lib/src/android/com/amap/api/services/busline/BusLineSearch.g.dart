...
class com_amap_api_services_busline_BusLineSearch extends java_lang_Object  {
  ...
  Future<com_amap_api_services_busline_BusLineResult> searchBusLine() async {
    ...
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod('com.amap.api.services.busline.BusLineSearch::searchBusLine', {"__this__": this});
  ...
  Future<void> setOnBusLineSearchListener(com_amap_api_services_busline_BusLineSearch_OnBusLineSearchListener var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod('com.amap.api.services.busline.BusLineSearch::setOnBusLineSearchListener', {"__this__": this});
  ...
  Future<void> searchBusLineAsyn() async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod('com.amap.api.services.busline.BusLineSearch::searchBusLineAsyn', {"__this__": this});
  ...
  Future<void> setQuery(com_amap_api_services_busline_BusLineQuery var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod('com.amap.api.services.busline.BusLineSearch::setQuery', {"var1": var1, "__this__": this});
  ...
  Future<com_amap_api_services_busline_BusLineQuery> getQuery() async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod('com.amap.api.services.busline.BusLineSearch::getQuery', {"__this__": this});
...
extension com_amap_api_services_busline_BusLineSearch_Batch on List<com_amap_api_services_busline_BusLineSearch> {
  ...
  Future<List<com_amap_api_services_busline_BusLineResult>> searchBusLine_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod('com.amap.api.services.busline.BusLineSearch::searchBusLine_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"__this__": this[__i__]}]);
  ...
  Future<List<void>> searchBusLineAsyn_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod('com.amap.api.services.busline.BusLineSearch::searchBusLineAsyn_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"__this__": this[__i__]}]);
  ...
  Future<List<void>> setQuery_batch(List<com_amap_api_services_busline_BusLineQuery> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod('com.amap.api.services.busline.BusLineSearch::setQuery_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__], "__this__": this[__i__]}]);
  ...
  Future<List<com_amap_api_services_busline_BusLineQuery>> getQuery_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod('com.amap.api.services.busline.BusLineSearch::getQuery_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"__this__": this[__i__]}]);
