...
class com_amap_api_services_busline_BusStationQuery extends java_lang_Object  {
  ...
  static Future<com_amap_api_services_busline_BusStationQuery> create__String__String(String var1, String var2) async {
    final __result__ = await kAmapSearchFluttifyChannel.invokeMethod<Ref>('ObjectFactory::createcom_amap_api_services_busline_BusStationQuery__String__String', {"var1": var1, "var2": var2});
    final object = com_amap_api_services_busline_BusStationQuery()..refId = __result__.refId;
    return object;
  }
  ...
  static Future<List<com_amap_api_services_busline_BusStationQuery>> create_batch__String__String(List<String> var1, List<String> var2) async {
    ...
    final resultBatch = await kAmapSearchFluttifyChannel.invokeListMethod<Ref>('ObjectFactory::create_batchcom_amap_api_services_busline_BusStationQuery__String__String', [for (int __i__ = 0; __i__ < var1.length; __i__++) {"var1": var1[__i__], "var2": var2[__i__]}]);
    return resultBatch.map((it) => com_amap_api_services_busline_BusStationQuery()..refId = it.refId).toList();
  }
