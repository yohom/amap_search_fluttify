...
class com_amap_api_services_busline_BusLineSearch extends Ref_Android  {
  ...
  // 生成方法们
   Future<com_amap_api_services_busline_BusLineResult> searchBusLine() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineSearch::searchBusLine', {"refId": refId});
   ...
   Future<void> setOnBusLineSearchListener(com_amap_api_services_busline_BusLineSearch_OnBusLineSearchListener var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineSearch::setOnBusLineSearchListener', {"refId": refId});
   ...
   Future<void> searchBusLineAsyn() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineSearch::searchBusLineAsyn', {"refId": refId});
   ...
   Future<void> setQuery(com_amap_api_services_busline_BusLineQuery var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineSearch::setQuery', {"var1": var1.refId, "refId": refId});
   ...
   Future<com_amap_api_services_busline_BusLineQuery> getQuery() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineSearch::getQuery', {"refId": refId});
