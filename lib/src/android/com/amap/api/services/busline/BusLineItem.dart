...
class com_amap_api_services_busline_BusLineItem extends java_lang_Object  {
  ...
  Future<double> getDistance() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineItem::getDistance', {"refId": refId});
  ...
  Future<void> setDistance(double var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineItem::setDistance', {"var1": var1, "refId": refId});
  ...
  Future<String> getBusLineName() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineItem::getBusLineName', {"refId": refId});
  ...
  Future<void> setBusLineName(String var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineItem::setBusLineName', {"var1": var1, "refId": refId});
  ...
  Future<String> getBusLineType() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineItem::getBusLineType', {"refId": refId});
  ...
  Future<void> setBusLineType(String var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineItem::setBusLineType', {"var1": var1, "refId": refId});
  ...
  Future<String> getCityCode() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineItem::getCityCode', {"refId": refId});
  ...
  Future<void> setCityCode(String var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineItem::setCityCode', {"var1": var1, "refId": refId});
  ...
  Future<void> setDirectionsCoordinates(List<com_amap_api_services_core_LatLonPoint> var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineItem::setDirectionsCoordinates', {"var1": var1.map((it) => it.refId).toList(), "refId": refId});
  ...
  Future<void> setBounds(List<com_amap_api_services_core_LatLonPoint> var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineItem::setBounds', {"var1": var1.map((it) => it.refId).toList(), "refId": refId});
  ...
  Future<String> getBusLineId() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineItem::getBusLineId', {"refId": refId});
  ...
  Future<void> setBusLineId(String var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineItem::setBusLineId', {"var1": var1, "refId": refId});
  ...
  Future<String> getOriginatingStation() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineItem::getOriginatingStation', {"refId": refId});
  ...
  Future<void> setOriginatingStation(String var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineItem::setOriginatingStation', {"var1": var1, "refId": refId});
  ...
  Future<String> getTerminalStation() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineItem::getTerminalStation', {"refId": refId});
  ...
  Future<void> setTerminalStation(String var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineItem::setTerminalStation', {"var1": var1, "refId": refId});
  ...
  Future<String> getBusCompany() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineItem::getBusCompany', {"refId": refId});
  ...
  Future<void> setBusCompany(String var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineItem::setBusCompany', {"var1": var1, "refId": refId});
  ...
  Future<double> getBasicPrice() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineItem::getBasicPrice', {"refId": refId});
  ...
  Future<void> setBasicPrice(double var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineItem::setBasicPrice', {"var1": var1, "refId": refId});
  ...
  Future<double> getTotalPrice() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineItem::getTotalPrice', {"refId": refId});
  ...
  Future<void> setTotalPrice(double var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineItem::setTotalPrice', {"var1": var1, "refId": refId});
  ...
  Future<void> setBusStations(List<com_amap_api_services_busline_BusStationItem> var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.services.busline.BusLineItem::setBusStations', {"var1": var1.map((it) => it.refId).toList(), "refId": refId});
