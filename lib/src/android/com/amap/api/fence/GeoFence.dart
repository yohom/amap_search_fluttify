...
class com_amap_api_fence_GeoFence extends java_lang_Object  {
  ...
  Future<List<com_amap_api_location_DPoint>> getPointList() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.fence.GeoFence::getPointList', {"refId": refId});
  ...
  Future<void> setPointList(List<List<com_amap_api_location_DPoint>> var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.fence.GeoFence::setPointList', {"var1": [], "refId": refId});
