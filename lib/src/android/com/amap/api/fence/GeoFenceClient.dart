...
class com_amap_api_fence_GeoFenceClient extends Ref_Android  {
  ...
  // 生成方法们
   Future<void> setActivateAction(int var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.fence.GeoFenceClient::setActivateAction', {"var1": var1, "refId": refId});
   ...
   Future<void> setGeoFenceListener(com_amap_api_fence_GeoFenceListener var1) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.fence.GeoFenceClient::setGeoFenceListener', {"refId": refId});
   ...
   Future<void> addGeoFence(com_amap_api_location_DPoint var1, double var2, String var3) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.fence.GeoFenceClient::addGeoFence', {"var1": var1.refId, "var2": var2, "var3": var3, "refId": refId});
   ...
   Future<void> removeGeoFence() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.fence.GeoFenceClient::removeGeoFence', {"refId": refId});
   ...
   Future<void> setGeoFenceAble(String var1, bool var2) async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.fence.GeoFenceClient::setGeoFenceAble', {"var1": var1, "var2": var2, "refId": refId});
   ...
   Future<void> pauseGeoFence() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.fence.GeoFenceClient::pauseGeoFence', {"refId": refId});
   ...
   Future<void> resumeGeoFence() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.fence.GeoFenceClient::resumeGeoFence', {"refId": refId});
   ...
   Future<bool> isPause() async {
    ...
    // 调用原生方法
    final result = await _channel.invokeMethod('com.amap.api.fence.GeoFenceClient::isPause', {"refId": refId});
