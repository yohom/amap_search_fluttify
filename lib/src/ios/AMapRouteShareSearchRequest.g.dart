...
extension AMapRouteShareSearchRequest_Batch on List<AMapRouteShareSearchRequest> {
  ...
  Future<void> set_strategy_batch(List<int> strategy) async {
    await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('AMapRouteShareSearchRequest::set_strategy_batch', [for (int i = 0; i < this.length; i++) {'refId': this[i].refId, "strategy": strategy[i]}]);
  
  
  }
  
  Future<void> set_type_batch(List<int> type) async {
    await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('AMapRouteShareSearchRequest::set_type_batch', [for (int i = 0; i < this.length; i++) {'refId': this[i].refId, "type": type[i]}]);
  
  
  }
  
  Future<void> set_startCoordinate_batch(List<AMapGeoPoint> startCoordinate) async {
    await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('AMapRouteShareSearchRequest::set_startCoordinate_batch', [for (int i = 0; i < this.length; i++) {'refId': this[i].refId, "startCoordinate": startCoordinate[i].refId}]);
  
  
  }
  
  Future<void> set_destinationCoordinate_batch(List<AMapGeoPoint> destinationCoordinate) async {
    await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('AMapRouteShareSearchRequest::set_destinationCoordinate_batch', [for (int i = 0; i < this.length; i++) {'refId': this[i].refId, "destinationCoordinate": destinationCoordinate[i].refId}]);
  
  
  }
  
  Future<void> set_startName_batch(List<String> startName) async {
    await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('AMapRouteShareSearchRequest::set_startName_batch', [for (int i = 0; i < this.length; i++) {'refId': this[i].refId, "startName": startName[i]}]);
  
  
  }
  
  Future<void> set_destinationName_batch(List<String> destinationName) async {
    await MethodChannel('me.yohom/amap_search_fluttify').invokeMethod('AMapRouteShareSearchRequest::set_destinationName_batch', [for (int i = 0; i < this.length; i++) {'refId': this[i].refId, "destinationName": destinationName[i]}]);
