...
extension AMapNearbySearchResponse_Batch on List<AMapNearbySearchResponse> {
  ...
  Future<List<List<AMapNearbyUserInfo>>> get_infos_batch() async {
    ...
    final typedResult = (resultBatch as List).map((__result__) => (__result__ as List).cast<int>().map((__it__) => AMapNearbyUserInfo()..refId = __it__..tag__ = 'amap_search_fluttify').toList()).toList();
