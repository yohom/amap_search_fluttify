...
class AMapBusStop extends AMapSearchObject with NSCoding, NSCopying {
  ...
  static Future<AMapBusStop> create__({ bool init = true /* ios only */ }) async {
    final refId = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::createAMapBusStop', {'init': init});
  ...
  static Future<List<AMapBusStop>> create_batch__(int length, { bool init = true /* ios only */ }) async {
    ...
    final List resultBatch = await kAmapSearchFluttifyChannel.invokeMethod('ObjectFactory::create_batchAMapBusStop', {'length': length, 'init': init});
