...
extension AMapPOI_Batch on List<AMapPOI> {
  ...
  Future<List<AMapIndoorData>> get_indoorData_batch() async {
    ...
    final typedResult = (resultBatch as List).map((__result__) => AMapIndoorData()..refId = __result__..tag__ = 'amap_search_fluttify').toList();
    kNativeObjectPool.addAll(typedResult);
    return typedResult;
  }
  ...
  Future<List<List<AMapSubPOI>>> get_subPOIs_batch() async {
    ...
    final typedResult = (resultBatch as List).map((__result__) => (__result__ as List).cast<int>().map((__it__) => AMapSubPOI()..refId = __it__..tag__ = 'amap_search_fluttify').toList()).toList();
  ...
  Future<List<List<AMapImage>>> get_images_batch() async {
    ...
    final typedResult = (resultBatch as List).map((__result__) => (__result__ as List).cast<int>().map((__it__) => AMapImage()..refId = __it__..tag__ = 'amap_search_fluttify').toList()).toList();
    kNativeObjectPool.addAll(typedResult.expand((e) => e));
    return typedResult;
  }
  ...
  Future<List<AMapPOIExtension>> get_extensionInfo_batch() async {
    ...
    final typedResult = (resultBatch as List).map((__result__) => AMapPOIExtension()..refId = __result__..tag__ = 'amap_search_fluttify').toList();
    kNativeObjectPool.addAll(typedResult);
    return typedResult;
  }
