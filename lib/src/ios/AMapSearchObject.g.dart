...
class AMapSearchObject extends NSObject with NSCoding, NSCopying {
  ...
  static Future<AMapSearchObject> create__() async {
    final refId = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec('amap_search_fluttify'))).invokeMethod('ObjectFactory::createAMapSearchObject');
  ...
  static Future<List<AMapSearchObject>> create_batch__(int length) async {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec('amap_search_fluttify'))).invokeMethod('ObjectFactory::create_batchAMapSearchObject', {'length': length});
