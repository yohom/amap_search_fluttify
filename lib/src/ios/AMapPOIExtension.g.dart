...
class AMapPOIExtension extends AMapSearchObject with NSCoding, NSCopying {
  ...
  static Future<AMapPOIExtension> create__() async {
    final refId = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod('ObjectFactory::createAMapPOIExtension');
  ...
  static Future<List<AMapPOIExtension>> create_batch__(int length) async {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod('ObjectFactory::create_batchAMapPOIExtension', {'length': length});
  ...
  Future<double> get_rating() async {
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod("AMapPOIExtension::get_rating", {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
  
  Future<double> get_cost() async {
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod("AMapPOIExtension::get_cost", {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
  
  Future<String> get_openTime() async {
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod("AMapPOIExtension::get_openTime", {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
  ...
  Future<void> set_rating(double rating) async {
    await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec()))
        .invokeMethod('AMapPOIExtension::set_rating', <String, dynamic>{'__this__': this, "rating": rating});
  ...
  Future<void> set_cost(double cost) async {
    await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec()))
        .invokeMethod('AMapPOIExtension::set_cost', <String, dynamic>{'__this__': this, "cost": cost});
  ...
  Future<void> set_openTime(String openTime) async {
    await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec()))
        .invokeMethod('AMapPOIExtension::set_openTime', <String, dynamic>{'__this__': this, "openTime": openTime});
...
extension AMapPOIExtension_Batch on List<AMapPOIExtension> {
  ...
  Future<List<double>> get_rating_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod("AMapPOIExtension::get_rating_batch", [for (final __item__ in this) {'__this__': __item__}]);
  ...
  Future<List<double>> get_cost_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod("AMapPOIExtension::get_cost_batch", [for (final __item__ in this) {'__this__': __item__}]);
  ...
  Future<List<String>> get_openTime_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod("AMapPOIExtension::get_openTime_batch", [for (final __item__ in this) {'__this__': __item__}]);
