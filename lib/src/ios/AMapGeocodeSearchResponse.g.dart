...
extension AMapGeocodeSearchResponse_Batch on List<AMapGeocodeSearchResponse> {
  ...
  Future<List<List<AMapGeocode>>> get_geocodes_batch() async {
    ...
    final typedResult = (resultBatch as List).cast<int>().map((__result__) => (__result__ as List).cast<int>().map((__it__) => AMapGeocode()..refId = __it__..tag__ = 'amap_search_fluttify').toList()).toList();
