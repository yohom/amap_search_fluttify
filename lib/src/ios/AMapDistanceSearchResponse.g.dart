...
class AMapDistanceSearchResponse extends AMapSearchObject with NSCoding, NSCopying {
  ...
  static Future<AMapDistanceSearchResponse> create__() async {
    final refId = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec('amap_search_fluttify'))).invokeMethod('ObjectFactory::createAMapDistanceSearchResponse');
  ...
  static Future<List<AMapDistanceSearchResponse>> create_batch__(int length) async {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec('amap_search_fluttify'))).invokeMethod('ObjectFactory::create_batchAMapDistanceSearchResponse', {'length': length});
