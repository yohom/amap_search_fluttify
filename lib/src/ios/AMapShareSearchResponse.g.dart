...
class AMapShareSearchResponse extends AMapSearchObject with NSCoding, NSCopying {
  ...
  Future<String> get_shareURL() async {
    final __result__ = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod("AMapShareSearchResponse::get_shareURL", {'__this__': this});
...
extension AMapShareSearchResponse_Batch on List<AMapShareSearchResponse> {
  ...
  Future<List<String>> get_shareURL_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod("AMapShareSearchResponse::get_shareURL_batch", [for (final __item__ in this) {'__this__': __item__}]);
