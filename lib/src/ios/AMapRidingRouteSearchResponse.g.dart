...
class AMapRidingRouteSearchResponse extends AMapRouteSearchResponse with NSCoding, NSCopying {
  ...
  static Future<AMapRidingRouteSearchResponse> create__() async {
    final refId = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec('amap_search_fluttify'))).invokeMethod('ObjectFactory::createAMapRidingRouteSearchResponse');
  ...
  static Future<List<AMapRidingRouteSearchResponse>> create_batch__(int length) async {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec('amap_search_fluttify'))).invokeMethod('ObjectFactory::create_batchAMapRidingRouteSearchResponse', {'length': length});
