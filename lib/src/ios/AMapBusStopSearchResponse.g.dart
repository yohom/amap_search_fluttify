...
class AMapBusStopSearchResponse extends AMapSearchObject with NSCoding, NSCopying {
  ...
  static Future<AMapBusStopSearchResponse> create__() async {
    final refId = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec('amap_search_fluttify'))).invokeMethod('ObjectFactory::createAMapBusStopSearchResponse');
  ...
  static Future<List<AMapBusStopSearchResponse>> create_batch__(int length) async {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_search_fluttify', StandardMethodCodec(FluttifyMessageCodec('amap_search_fluttify'))).invokeMethod('ObjectFactory::create_batchAMapBusStopSearchResponse', {'length': length});
